...
wk.add({
    ...
    },
    {
        ...
        function()
            ...
            for _, client in ipairs(clients) do
                table.insert(msg, string.format("• %s (id: %d)", client.name, client.id))
            end
            vim.ui.list(msg, { prompt = "LSP Clients:" })
        end,
        desc = "Show LSP clients",
    },
    ...
    },
    {
        "<Leader>js",
        function()
            require("config.jujube").open_jj_status()
        end,
        desc = "Jujube: status",
    },
    {
        "<Leader>jg",
        function()
            require("config.jujube").open_jj_log()
        end,
        desc = "Jujube: log",
    },
    {
        "<Leader>jd",
        function()
            require("config.jujube").open_jj_diff()
        end,
        desc = "Jujube: diff",
    },
    -- Utility mappings
