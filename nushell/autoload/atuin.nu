# Atuin integration for nushell - only C-r triggers interactive search
# Up/down arrows use normal shell history
...
# Only C-r triggers atuin interactive search
# Up/down arrows will use nushell's built-in history navigation
$env.config = (
